...
def get_cifar10():
    ...
    train_dataset = datasets.CIFAR10('../data', train=True, download=True, transform=trans_cifar10_train)
    test_dataset = datasets.CIFAR10('../data', train=False, download=True, transform=trans_cifar10_test)
...
def cifar10_noniid_lt(train_dataset, NUM_DEVICE, n_list=None):
...
def start_training_task_noniid():
    train_loader, test_loader, prototype_loader, train_dataset = get_cifar10()
    dict_users = cifar10_noniid_lt(train_dataset, NUM_DEVICE)
    user_data_loaders = get_data_loaders(train_dataset, dict_users)
    model, prototypes = train_cifar10_noniid(epochs=epochs, user_data_loaders=user_data_loaders, test_loader=test_loader, learning_rate=0.0001)
